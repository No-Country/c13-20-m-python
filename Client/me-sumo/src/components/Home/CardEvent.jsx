...
export default function CardEvent({
  ...
  return (
    <Card className="mt-6 w-96 border border-gray-300 rounded">
      ...
      <CardBody>
        <Typography variant="h2" color="blue-gray" font="poppins" weight="semibold" className="mb-2 text-xs">
          {name}
        </Typography>
        <div className="mb-2">
          <div className="flex items-center">
            <BsCalendar3 size={20} className="mr-2" />
            <Typography variant="h6" color="blue-gray" font="poppins" weight="light" className="text-xs">
