...
class Event(models.Model):
    ...
    # eventImages  =  models.ImageField(null = True, blank = True, upload_to= 'images/')            # Para usar models.ImageField(upload_to = PATH   ) hay que instalar Pillow, se supone que trabaja mejor con las imagenes (nunca lo use)
